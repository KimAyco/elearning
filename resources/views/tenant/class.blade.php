    ...
    <div class="main-content">
        <header class="topbar">
            <div style="display:flex; align-items:center; gap:12px;">
                ...
                <span class="topbar-title">Class</span>
            </div>
                ...
                @else
                    <div class="mdl-course-grid">
                        @foreach ($classSubjectRows as $row)
                            <a class="mdl-course-card" href="{{ url('/tenant/classes/' . ($row['class_group_id'] ?? 0) . '/' . ($row['subject_id'] ?? 0)) }}">
                                ...
                                <div class="mdl-course-card-title">{{ $row['subject_title'] }}</div>
